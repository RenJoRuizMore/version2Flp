(function(A) {
	...
	if (!Array.prototype.forEach)
		...
		markersData = {
			...
			{
				name: 'DJ Juanxo',
				location_latitude: -5.2024836, 
				location_longitude: -80.6198865,
				map_image_url: 'img/img.png',
				name_point: 'Casa de Juanxo',
				description_point: 'Servicio de Disc Jockey',
				url_point: '02.html'
			},
			{
				name: 'Coogee Beach',
			...
			'Park': [
			{
				name: 'Plazuela Montero',
				location_latitude: -5.201575,
				location_longitude: -80.622151,
				map_image_url: 'img/img.png',
				name_point: 'Plazuela Montero',
				description_point: 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard',
				url_point: '02.html'
			},
			{
		...
		function initialize () {
			var mapOptions = new google.maps.Map(document.getElementById('map'), {
				center: {lat: -5.197020, lng: -80.626615},
				zoom: 16
			});
			...
			if (navigator.geolocation) {
				navigator.geolocation.getCurrentPosition(function(position) {
					...
					infoWindow.setContent('Ubicación encontrad.');
					map.setCenter(pos);
				}, function() {
		...
		function getInfoBox(item) {
			return new InfoBox({
				...
				'<a href="'+ item.url_point + '" class="green_btn">Más información</a>' +
